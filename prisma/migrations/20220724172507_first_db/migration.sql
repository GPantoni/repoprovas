...
CREATE TABLE "tests" (
    ...
    "disciplinesTeachersId" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_disciplinesTeachersId_fkey" FOREIGN KEY ("disciplinesTeachersId") REFERENCES "DisciplinesTeachers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
